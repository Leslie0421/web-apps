...
const MainPage = inject(
  ...
  observer((props) => {
    ...
    const isAvailableExt =
      docExt && docExt !== "djvu" && docExt !== "pdf" && docExt !== "xps";
    ...
    const isFabShow =
      ...
      isAvailableExt &&
      isEdit &&
      (!isProtected || typeProtection === Asc.c_oAscEDocProtect.TrackedChanges);
    ...
    return (
      <Themes fileType={docExt}>
        ...
        >
          <Page
            name="home"
            className={`editor${!isHideLogo ? " page-with-logo" : ""}`}
          >
            <Navbar
              id="editor-navbar"
            ...
            {!state.collaborationVisible ? null : (
              <CollaborationView closeOptions={handleOptionsViewClosed} />
            )}
            ...
            {isFabShow && !isVersionHistoryMode && (
              ...
              >
                <div
                  className="fab fab-right-bottom"
                  onClick={() => turnOffViewerMode()}
                >
                  <a href="#">
